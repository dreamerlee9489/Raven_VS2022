...
$SG100141 DB	', ', 00H
	ORG $+1
$SG104549 DB	'invalid argument', 00H
	ORG $+3
$SG104550 DB	'%s', 00H
	ORG $+1
$SG104553 DB	00H, 00H
	ORG $+2
$SG104551 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
	DB	'VC\Tools\MSVC\14.34.31933\include\xmemory', 00H
	ORG $+6
$SG104552 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
	...
	DB	00H, 00H
$SG104554 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
...
$LN7@Allocate_m:
	push	OFFSET $SG104549
	push	OFFSET $SG104550
	push	0
	push	135					; 00000087H
	push	OFFSET $SG104551
	push	2
	call	__CrtDbgReport
...
$LN12@Allocate_m:
	push	0
	push	135					; 00000087H
	push	OFFSET $SG104552
	push	OFFSET $SG104553
	push	OFFSET $SG104554
