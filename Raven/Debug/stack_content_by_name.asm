...
$SG101470 DB	', ', 00H
	ORG $+1
$SG105935 DB	'invalid argument', 00H
	ORG $+3
$SG105936 DB	'%s', 00H
	ORG $+1
$SG105939 DB	00H, 00H
	ORG $+2
$SG105937 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
	DB	'VC\Tools\MSVC\14.33.31629\include\xmemory', 00H
	ORG $+6
$SG105938 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
	...
	DB	00H, 00H
$SG105940 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
...
$LN7@Allocate_m:
	push	OFFSET $SG105935
	push	OFFSET $SG105936
	push	0
	push	137					; 00000089H
	push	OFFSET $SG105937
	push	2
	call	__CrtDbgReport
...
$LN12@Allocate_m:
	push	0
	push	137					; 00000089H
	push	OFFSET $SG105938
	push	OFFSET $SG105939
	push	OFFSET $SG105940
