...
CONST	SEGMENT
$SG81965 DB	'luabind.function', 00H
?yield@luabind@@3U?$policy_cons@Uyield_policy@detail@luabind@@Unull_type@23@@detail@1@B	ORG $+1 ; luabind::yield
	ORG $+2
$SG81967 DB	'__gc', 00H
	ORG $+3
$SG81968 DB	'luabind.function', 00H
	ORG $+3
$SG82551 DB	'<unknown>', 00H
	ORG $+2
$SG82554 DB	'No matching overload found, candidates:', 0aH, 00H
	ORG $+3
$SG82556 DB	0aH, 00H
	ORG $+2
$SG82557 DB	'Ambiguous, candidates:', 0aH, 00H
$SG82559 DB	0aH, 00H
	ORG $+2
$SG86574 DB	'invalid argument', 00H
	ORG $+3
$SG86575 DB	'%s', 00H
	ORG $+1
$SG86576 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
	DB	'VC\Tools\MSVC\14.35.32215\include\xmemory', 00H
	ORG $+2
$SG86578 DB	00H, 00H
	ORG $+2
$SG86577 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
	...
	DB	00H, 00H
$SG86579 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
...
?function_tag@?A0xeb7e0b9c@detail@luabind@@3HA DD 01H DUP (?) ; luabind::detail::`anonymous namespace'::function_tag
_BSS	ENDS
CRT$XCU	SEGMENT
...
_result$ = -1						; size = 1
_obj$ = 8						; size = 4
?is_luabind_function@?A0xeb7e0b9c@detail@luabind@@YA_NABVobject@adl@3@@Z PROC ; luabind::detail::`anonymous namespace'::is_luabind_function
...
; 66   :   }
	...
	pop	ebp
	ret	0
?is_luabind_function@?A0xeb7e0b9c@detail@luabind@@YA_NABVobject@adl@3@@Z ENDP ; luabind::detail::`anonymous namespace'::is_luabind_function
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File D:\__Repos\__MyRepos\Raven_VS2022\Common\luabind-0.9.1\src\function.cpp
_TEXT	SEGMENT
...
; 52   :     bool result = lua_touserdata(L, -1) == &function_tag;
	...
	call	_lua_touserdata
	add	esp, 8
	cmp	eax, OFFSET ?function_tag@?A0xeb7e0b9c@detail@luabind@@3HA ; luabind::detail::`anonymous namespace'::function_tag
...
_TEXT	SEGMENT
_L$ = 8							; size = 4
?push_function_metatable@?A0xeb7e0b9c@detail@luabind@@YAXPAUlua_State@@@Z PROC ; luabind::detail::`anonymous namespace'::push_function_metatable
...
; 34   :       lua_pushcclosure(L, &function_destroy, 0);
	...
	push	0
	push	OFFSET ?function_destroy@?A0xeb7e0b9c@detail@luabind@@YAHPAUlua_State@@@Z ; luabind::detail::`anonymous namespace'::function_destroy
	mov	eax, DWORD PTR _L$[ebp]
	push	eax
...
; 40   :   }
	...
	pop	ebp
	ret	0
?push_function_metatable@?A0xeb7e0b9c@detail@luabind@@YAXPAUlua_State@@@Z ENDP ; luabind::detail::`anonymous namespace'::push_function_metatable
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File D:\__Repos\__MyRepos\Raven_VS2022\Common\luabind-0.9.1\src\function.cpp
_TEXT	SEGMENT
...
_fn$ = -4						; size = 4
_L$ = 8							; size = 4
?function_destroy@?A0xeb7e0b9c@detail@luabind@@YAHPAUlua_State@@@Z PROC ; luabind::detail::`anonymous namespace'::function_destroy
...
; 19   :   }
	...
	pop	ebp
	ret	0
?function_destroy@?A0xeb7e0b9c@detail@luabind@@YAHPAUlua_State@@@Z ENDP ; luabind::detail::`anonymous namespace'::function_destroy
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File D:\__Repos\__MyRepos\Raven_VS2022\Common\luabind-0.9.1\src\function.cpp
_TEXT	SEGMENT
...
; 78   :         if (is_luabind_function(overloads) && is_luabind_function(fn))
	...
	lea	eax, DWORD PTR _overloads$7[ebp]
	push	eax
	call	?is_luabind_function@?A0xeb7e0b9c@detail@luabind@@YA_NABVobject@adl@3@@Z ; luabind::detail::`anonymous namespace'::is_luabind_function
	add	esp, 4
	movzx	ecx, al
	test	ecx, ecx
	je	SHORT $LN2@add_overlo
...
; 91   :     push_function_metatable(L);
	...
	mov	ecx, DWORD PTR _L$[ebp]
	push	ecx
	call	?push_function_metatable@?A0xeb7e0b9c@detail@luabind@@YAXPAUlua_State@@@Z ; luabind::detail::`anonymous namespace'::push_function_metatable
	add	esp, 4
...
; 95   :     lua_pushlightuserdata(L, &function_tag);
	...
	push	OFFSET ?function_tag@?A0xeb7e0b9c@detail@luabind@@3HA ; luabind::detail::`anonymous namespace'::function_tag
	mov	edx, DWORD PTR _L$[ebp]
	push	edx
...
; 105  :     char const* function_name =
	...
	mov	DWORD PTR tv72[ebp], OFFSET $SG82551
