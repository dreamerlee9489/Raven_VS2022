...
_BSS	ENDS
CONST	SEGMENT
$SG174017 DB	0c2H, 0d3H, 0b6H, 0e1H, 0d5H, 0dfH, 00H
$SG174096 DB	00H
$SG174019 DB	'MyWindowClass', 00H
	ORG $+2
$SG174093 DB	'map', 00H
$SG174094 DB	'Raven map file (*.map)', 00H
	ORG $+1
$SG174095 DB	'Filename: ', 00H
	ORG $+1
$SG174149 DB	'Error', 00H
	ORG $+2
$SG174150 DB	'Registration Failed!', 00H
	ORG $+3
$SG174153 DB	'Error!', 00H
	ORG $+1
$SG174154 DB	'CreateWindowEx Failed!', 00H
	ORG $+1
?colors@@3QBKB DD 0ffH					; colors
	...
	DD	0c8c8c8H
	DD	0e6e6ffH
$SG183054 DB	'invalid argument', 00H
	ORG $+3
$SG183055 DB	'%s', 00H
	ORG $+1
$SG183058 DB	00H, 00H
	ORG $+2
$SG183056 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
	DB	'VC\Tools\MSVC\14.34.31933\include\xmemory', 00H
	ORG $+6
$SG183057 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
	...
	DB	00H, 00H
$SG183059 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
	DB	'i', 00H, 'd', 00H, ' ', 00H, 'a', 00H, 'r', 00H, 'g', 00H, 'u'
	DB	00H, 'm', 00H, 'e', 00H, 'n', 00H, 't', 00H, '"', 00H, 00H, 00H
	ORG $+6
$SG183161 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
	DB	'VC\Tools\MSVC\14.34.31933\include\xlocale', 00H
CONST	ENDS
_DATA	SEGMENT
?g_szApplicationName@@3PADA DD FLAT:$SG174017		; g_szApplicationName
?g_szWindowClassName@@3PADA DD FLAT:$SG174019		; g_szWindowClassName
_DATA	ENDS
...
$LN7@Allocate_m:
	push	OFFSET $SG183054
	push	OFFSET $SG183055
	push	0
	push	135					; 00000087H
	push	OFFSET $SG183056
	push	2
	call	__CrtDbgReport
...
$LN12@Allocate_m:
	push	0
	push	135					; 00000087H
	push	OFFSET $SG183057
	push	OFFSET $SG183058
...
; 206  : 			debug_con << "Filename: " << szTitleName << "";
	...
	push	OFFSET $SG174096
	push	OFFSET ?szTitleName@?1??WindowProc@@YGJPAUHWND__@@IIJ@Z@4PADA
	push	OFFSET $SG174095
...
; 463  : 		MessageBox(NULL, "Registration Failed!", "Error", 0);
	...
	mov	esi, esp
	push	0
	push	OFFSET $SG174149
	push	OFFSET $SG174150
	push	0
