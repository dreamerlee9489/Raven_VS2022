...
_BSS	ENDS
CONST	SEGMENT
$SG174097 DB	0c2H, 0d3H, 0b6H, 0e1H, 0d5H, 0dfH, 00H
$SG174176 DB	00H
$SG174099 DB	'MyWindowClass', 00H
	ORG $+2
$SG174173 DB	'map', 00H
$SG174174 DB	'Raven map file (*.map)', 00H
	ORG $+1
$SG174175 DB	'Filename: ', 00H
	ORG $+1
$SG174229 DB	'Error', 00H
	ORG $+2
$SG174230 DB	'Registration Failed!', 00H
	ORG $+3
$SG174233 DB	'Error!', 00H
	ORG $+1
$SG174234 DB	'CreateWindowEx Failed!', 00H
	ORG $+1
?colors@@3QBKB DD 0ffH					; colors
	...
	DD	0c8c8c8H
	DD	0e6e6ffH
$SG183149 DB	'invalid argument', 00H
	ORG $+3
$SG183150 DB	'%s', 00H
	ORG $+1
$SG183153 DB	00H, 00H
	ORG $+2
$SG183151 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
	DB	'VC\Tools\MSVC\14.35.32215\include\xmemory', 00H
	ORG $+6
$SG183152 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
	...
	DB	00H, 00H
$SG183154 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
	DB	'i', 00H, 'd', 00H, ' ', 00H, 'a', 00H, 'r', 00H, 'g', 00H, 'u'
	DB	00H, 'm', 00H, 'e', 00H, 'n', 00H, 't', 00H, '"', 00H, 00H, 00H
	ORG $+6
$SG183255 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
	DB	'VC\Tools\MSVC\14.35.32215\include\xlocale', 00H
CONST	ENDS
_DATA	SEGMENT
?g_szApplicationName@@3PADA DD FLAT:$SG174097		; g_szApplicationName
?g_szWindowClassName@@3PADA DD FLAT:$SG174099		; g_szWindowClassName
_DATA	ENDS
...
$LN7@Allocate_m:
	push	OFFSET $SG183149
	push	OFFSET $SG183150
	push	0
	push	135					; 00000087H
	push	OFFSET $SG183151
	push	2
	call	__CrtDbgReport
...
$LN12@Allocate_m:
	push	0
	push	135					; 00000087H
	push	OFFSET $SG183152
	push	OFFSET $SG183153
	push	OFFSET $SG183154
...
; 206  : 			debug_con << "Filename: " << szTitleName << "";
	...
	push	OFFSET $SG174176
	push	OFFSET ?szTitleName@?1??WindowProc@@YGJPAUHWND__@@IIJ@Z@4PADA
	push	OFFSET $SG174175
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File D:\Windows Kits\10\Include\10.0.22000.0\ucrt\time.h
_TEXT	SEGMENT
__Time$ = 8						; size = 4
_time	PROC
...
; 463  : 		MessageBox(NULL, "Registration Failed!", "Error", 0);
	...
	mov	esi, esp
	push	0
	push	OFFSET $SG174229
	push	OFFSET $SG174230
	push	0
