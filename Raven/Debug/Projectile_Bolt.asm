...
CONST	SEGMENT
$SG181095 DB	'invalid argument', 00H
	ORG $+3
$SG181096 DB	'%s', 00H
	ORG $+1
$SG181097 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
	DB	'VC\Tools\MSVC\14.33.31629\include\xmemory', 00H
	ORG $+2
$SG181099 DB	00H, 00H
	ORG $+2
$SG181098 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
	...
	DB	00H, 00H
$SG181100 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
...
?colors@@3QBKB DD 0ffH					; colors
	...
	DD	0c8c8c8H
	DD	0e6e6ffH
$SG181224 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
	DB	'VC\Tools\MSVC\14.33.31629\include\xlocale', 00H
	ORG $+2
$SG172018 DB	'Bolt_MaxForce', 00H
	ORG $+2
$SG172019 DB	'Bolt_Mass', 00H
	ORG $+2
$SG172020 DB	'Bolt_MaxSpeed', 00H
	ORG $+2
$SG172021 DB	'Bolt_Scale', 00H
	ORG $+1
$SG172022 DB	'Bolt_Damage', 00H
$SG172023 DB	'D', 00H, ':', 00H, '\', 00H, '_', 00H, '_', 00H, 'R', 00H
	...
	ORG $+2
$SG172024 DB	't', 00H, 'a', 00H, 'r', 00H, 'g', 00H, 'e', 00H, 't', 00H
...
$LN7@Allocate_m:
	push	OFFSET $SG181095
	push	OFFSET $SG181096
	push	0
	push	137					; 00000089H
	push	OFFSET $SG181097
	push	2
	call	__CrtDbgReport
...
$LN12@Allocate_m:
	push	0
	push	137					; 00000089H
	push	OFFSET $SG181098
	push	OFFSET $SG181099
	push	OFFSET $SG181100
