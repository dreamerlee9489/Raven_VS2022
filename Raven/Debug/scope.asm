...
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1lua_pop_stack@?A0x4df71d6a@luabind@@QAE@XZ PROC	; luabind::`anonymous namespace'::lua_pop_stack::~lua_pop_stack
; _this$ = ecx
...
; 122  :             }
	...
	pop	ebp
	ret	0
??1lua_pop_stack@?A0x4df71d6a@luabind@@QAE@XZ ENDP	; luabind::`anonymous namespace'::lua_pop_stack::~lua_pop_stack
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File D:\__Repos\__MyRepos\Raven_VS2022\Common\luabind-0.9.1\src\scope.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
_L$ = 8							; size = 4
??0lua_pop_stack@?A0x4df71d6a@luabind@@QAE@PAUlua_State@@@Z PROC ; luabind::`anonymous namespace'::lua_pop_stack::lua_pop_stack
; _this$ = ecx
...
; 117  :             }
	...
	pop	ebp
	ret	4
??0lua_pop_stack@?A0x4df71d6a@luabind@@QAE@PAUlua_State@@@Z ENDP ; luabind::`anonymous namespace'::lua_pop_stack::lua_pop_stack
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.34.31933\include\memory
...
; 157  :         lua_pop_stack guard(m_state);
	...
	call	??0lua_pop_stack@?A0x4df71d6a@luabind@@QAE@PAUlua_State@@@Z ; luabind::`anonymous namespace'::lua_pop_stack::lua_pop_stack
	mov	BYTE PTR __$EHRec$[ebp+8], 1
...
; 160  :     }
	...
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR _guard$[ebp]
	call	??1lua_pop_stack@?A0x4df71d6a@luabind@@QAE@XZ ; luabind::`anonymous namespace'::lua_pop_stack::~lua_pop_stack
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _s$[ebp]
	call	??1scope@luabind@@QAE@XZ		; luabind::scope::~scope
	push	edx
...
__unwindfunclet$??Amodule_@luabind@@QAEXUscope@1@@Z$1:
	lea	ecx, DWORD PTR _guard$[ebp]
	jmp	??1lua_pop_stack@?A0x4df71d6a@luabind@@QAE@XZ ; luabind::`anonymous namespace'::lua_pop_stack::~lua_pop_stack
	int	3
	int	3
	int	3
	int	3
