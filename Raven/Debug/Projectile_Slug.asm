...
CONST	SEGMENT
$SG172269 DB	'Slug_MaxForce', 00H
	ORG $+2
$SG172270 DB	'Slug_Mass', 00H
	ORG $+2
$SG172271 DB	'Slug_MaxSpeed', 00H
	ORG $+2
$SG172272 DB	'Slug_Scale', 00H
	ORG $+1
$SG172273 DB	'Slug_Damage', 00H
$SG172274 DB	'Slug_Persistance', 00H
	ORG $+3
$SG181332 DB	'invalid argument', 00H
	ORG $+3
$SG181333 DB	'%s', 00H
	ORG $+1
$SG181334 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
	DB	'VC\Tools\MSVC\14.34.31933\include\xmemory', 00H
	ORG $+2
$SG181336 DB	00H, 00H
	ORG $+2
$SG181335 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
	...
	DB	00H, 00H
$SG181337 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
...
?colors@@3QBKB DD 0ffH					; colors
	...
	DD	0c8c8c8H
	DD	0e6e6ffH
$SG181459 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
...
$LN7@Allocate_m:
	push	OFFSET $SG181332
	push	OFFSET $SG181333
	push	0
	push	135					; 00000087H
	push	OFFSET $SG181334
	push	2
	call	__CrtDbgReport
...
$LN12@Allocate_m:
	push	0
	push	135					; 00000087H
	push	OFFSET $SG181335
	push	OFFSET $SG181336
	push	OFFSET $SG181337
...
; 20   :         Raven_Projectile(target,
	...
	sub	esp, 8
	fstp	QWORD PTR [esp]
	push	OFFSET $SG172270
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	sub	esp, 8
	fstp	QWORD PTR [esp]
	push	OFFSET $SG172271
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	sub	esp, 8
	fstp	QWORD PTR [esp]
	push	OFFSET $SG172272
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	sub	esp, 8
	fstp	QWORD PTR [esp]
	push	OFFSET $SG172273
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
