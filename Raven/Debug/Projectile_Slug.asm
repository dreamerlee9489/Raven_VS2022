...
CONST	SEGMENT
$SG181197 DB	'invalid argument', 00H
	ORG $+3
$SG181198 DB	'%s', 00H
	ORG $+1
$SG181199 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
	DB	'VC\Tools\MSVC\14.33.31629\include\xmemory', 00H
	ORG $+2
$SG181201 DB	00H, 00H
	ORG $+2
$SG181200 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
	...
	DB	00H, 00H
$SG181202 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
...
?colors@@3QBKB DD 0ffH					; colors
	...
	DD	0c8c8c8H
	DD	0e6e6ffH
$SG181325 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
	DB	'VC\Tools\MSVC\14.33.31629\include\xlocale', 00H
	ORG $+2
$SG172015 DB	'Slug_MaxForce', 00H
	ORG $+2
$SG172016 DB	'Slug_Mass', 00H
	ORG $+2
$SG172017 DB	'Slug_MaxSpeed', 00H
	ORG $+2
$SG172018 DB	'Slug_Scale', 00H
	ORG $+1
$SG172019 DB	'Slug_Damage', 00H
$SG172020 DB	'Slug_Persistance', 00H
CONST	ENDS
...
$LN7@Allocate_m:
	push	OFFSET $SG181197
	push	OFFSET $SG181198
	push	0
	push	137					; 00000089H
	push	OFFSET $SG181199
	push	2
	call	__CrtDbgReport
...
$LN12@Allocate_m:
	push	0
	push	137					; 00000089H
	push	OFFSET $SG181200
	push	OFFSET $SG181201
	push	OFFSET $SG181202
...
; 20   :         Raven_Projectile(target,
	...
	push	OFFSET $SG172015
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	sub	esp, 8
	fstp	QWORD PTR [esp]
	push	OFFSET $SG172016
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	sub	esp, 8
	fstp	QWORD PTR [esp]
	push	OFFSET $SG172017
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	sub	esp, 8
	fstp	QWORD PTR [esp]
	push	OFFSET $SG172018
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	sub	esp, 8
	fstp	QWORD PTR [esp]
	push	OFFSET $SG172019
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
