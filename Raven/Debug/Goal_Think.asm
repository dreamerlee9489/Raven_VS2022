; Listing generated by Microsoft (R) Optimizing Compiler Version 19.35.32215.0 
	...
	TITLE	D:\__Repos\__MyRepos\Raven_VS2022\Raven\Debug\Goal_Think.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG173808 DB	'invalid argument', 00H
	ORG $+3
$SG173809 DB	'%s', 00H
	ORG $+1
$SG173810 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
	DB	'VC\Tools\MSVC\14.35.32215\include\xmemory', 00H
	ORG $+2
$SG173812 DB	00H, 00H
	ORG $+2
$SG173811 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
	...
	DB	00H, 00H
$SG173813 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
	DB	'i', 00H, 'd', 00H, ' ', 00H, 'a', 00H, 'r', 00H, 'g', 00H, 'u'
	DB	00H, 'm', 00H, 'e', 00H, 'n', 00H, 't', 00H, '"', 00H, 00H, 00H
	ORG $+2
$SG165898 DB	'<Goal_Think::Arbitrate>: no evaluator selected', 00H
	ORG $+1
?colors@@3QBKB DD 0ffH					; colors
	...
	DD	0c8c8c8H
	DD	0e6e6ffH
$SG165899 DB	'D', 00H, ':', 00H, '\', 00H, '_', 00H, '_', 00H, 'R', 00H
	...
	ORG $+6
$SG165900 DB	'M', 00H, 'o', 00H, 's', 00H, 't', 00H, 'D', 00H, 'e', 00H
	...
	DB	00H, 00H, 00H
	ORG $+4
$SG174786 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
...
PUBLIC	??_C@_1GK@CEPMINEG@?$AAD?$AA?3?$AA?2?$AA_?$AA_?$AAR?$AAe?$AAp?$AAo?$AAs?$AA?2?$AA_?$AA_?$AAM?$AAy@ ; `string'
...
CONST	ENDS
;	COMDAT ??_C@_1GK@CEPMINEG@?$AAD?$AA?3?$AA?2?$AA_?$AA_?$AAR?$AAe?$AAp?$AAo?$AAs?$AA?2?$AA_?$AA_?$AAM?$AAy@
CONST	SEGMENT
??_C@_1GK@CEPMINEG@?$AAD?$AA?3?$AA?2?$AA_?$AA_?$AAR?$AAe?$AAp?$AAo?$AAs?$AA?2?$AA_?$AA_?$AAM?$AAy@ DB 'D'
...
$LN7@Allocate_m:
	...
	push	OFFSET $SG173809
	push	0
	push	135					; 00000087H
	push	OFFSET $SG173810
	push	2
	call	__CrtDbgReport
...
$LN12@Allocate_m:
	push	0
	push	135					; 00000087H
	push	OFFSET $SG173811
	push	OFFSET $SG173812
...
; 1466 :     return _Left._Get_current() != _Right._Get_current();
...
; 1431 :     _NODISCARD constexpr const _BidIt& _Get_current() const noexcept {
...
; 1328 :     _CONSTEXPR17 reverse_iterator& operator++() noexcept(noexcept(--current)) /* strengthened */ {
...
; 1307 :         noexcept(is_nothrow_copy_constructible_v<_BidIt>&& noexcept(*--(_STD declval<_BidIt&>()))) /* strengthened */ {
...
; 1277 :     _CONSTEXPR17 explicit reverse_iterator(_BidIt _Right) noexcept(
...
; 1278 :         is_nothrow_move_constructible_v<_BidIt>) // strengthened
; 1279 :         : current(_STD move(_Right)) {}
...
; 1275 :     _CONSTEXPR17 reverse_iterator() = default;
...
; 1282 :     template <class _Other>
; 1283 : #ifdef __cpp_lib_concepts
; 1284 :         requires (!is_same_v<_Other, _BidIt>) && convertible_to<const _Other&, _BidIt>
; 1285 : #endif // __cpp_lib_concepts
; 1286 :     _CONSTEXPR17 reverse_iterator(const reverse_iterator<_Other>& _Right) noexcept(
; 1287 :         is_nothrow_constructible_v<_BidIt, const _Other&>) // strengthened
; 1288 :         : current(_Right.current) {}
; 1289 : 
; 1290 :     template <class _Other>
; 1291 : #ifdef __cpp_lib_concepts
; 1292 :         requires (!is_same_v<_Other, _BidIt>) && convertible_to<const _Other&, _BidIt>
; 1293 :             && assignable_from<_BidIt&, const _Other&>
; 1294 : #endif // __cpp_lib_concepts
; 1295 :     _CONSTEXPR17 reverse_iterator& operator=(const reverse_iterator<_Other>& _Right) noexcept(
; 1296 :         is_nothrow_assignable_v<_BidIt&, const _Other&>) /* strengthened */ {
; 1297 :         current = _Right.current;
; 1298 :         return *this;
; 1299 :     }
; 1300 :     // clang-format on
; 1301 : 
; 1302 :     _NODISCARD _CONSTEXPR17 _BidIt base() const noexcept(is_nothrow_copy_constructible_v<_BidIt>) /* strengthened */ {
; 1303 :         return current;
; 1304 :     }
; 1305 : 
; 1306 :     _NODISCARD _CONSTEXPR17 reference operator*() const
; 1307 :         noexcept(is_nothrow_copy_constructible_v<_BidIt>&& noexcept(*--(_STD declval<_BidIt&>()))) /* strengthened */ {
; 1308 :         _BidIt _Tmp = current;
; 1309 :         return *--_Tmp;
; 1310 :     }
; 1311 : 
; 1312 :     _NODISCARD _CONSTEXPR17 pointer operator->() const
; 1313 :         noexcept(is_nothrow_copy_constructible_v<_BidIt>&& noexcept(--(_STD declval<_BidIt&>()))
; 1314 :                  && _Has_nothrow_operator_arrow<_BidIt&, pointer>) /* strengthened */
; 1315 : #ifdef __cpp_lib_concepts
; 1316 :         requires (is_pointer_v<_BidIt> || requires(const _BidIt __i) { __i.operator->(); })
; 1317 : #endif
; 1318 :     {
; 1319 :         _BidIt _Tmp = current;
; 1320 :         --_Tmp;
; 1321 :         if constexpr (is_pointer_v<_BidIt>) {
; 1322 :             return _Tmp;
; 1323 :         } else {
; 1324 :             return _Tmp.operator->();
; 1325 :         }
; 1326 :     }
; 1327 : 
; 1328 :     _CONSTEXPR17 reverse_iterator& operator++() noexcept(noexcept(--current)) /* strengthened */ {
...
; 1331 :     }
; 1332 : 
; 1333 :     _CONSTEXPR17 reverse_iterator operator++(int) noexcept(
; 1334 :         is_nothrow_copy_constructible_v<_BidIt>&& noexcept(--current)) /* strengthened */ {
; 1335 :         reverse_iterator _Tmp = *this;
; 1336 :         --current;
; 1337 :         return _Tmp;
; 1338 :     }
; 1339 : 
; 1340 :     _CONSTEXPR17 reverse_iterator& operator--() noexcept(noexcept(++current)) /* strengthened */ {
; 1341 :         ++current;
; 1342 :         return *this;
; 1343 :     }
; 1344 : 
; 1345 :     _CONSTEXPR17 reverse_iterator operator--(int) noexcept(
; 1346 :         is_nothrow_copy_constructible_v<_BidIt>&& noexcept(++current)) /* strengthened */ {
; 1347 :         reverse_iterator _Tmp = *this;
; 1348 :         ++current;
; 1349 :         return _Tmp;
; 1350 :     }
; 1351 : 
; 1352 :     _NODISCARD _CONSTEXPR17 reverse_iterator operator+(const difference_type _Off) const
; 1353 :         noexcept(noexcept(reverse_iterator(current - _Off))) /* strengthened */ {
; 1354 :         return reverse_iterator(current - _Off);
; 1355 :     }
; 1356 : 
; 1357 :     _CONSTEXPR17 reverse_iterator& operator+=(const difference_type _Off) noexcept(
; 1358 :         noexcept(current -= _Off)) /* strengthened */ {
; 1359 :         current -= _Off;
; 1360 :         return *this;
; 1361 :     }
; 1362 : 
; 1363 :     _NODISCARD _CONSTEXPR17 reverse_iterator operator-(const difference_type _Off) const
; 1364 :         noexcept(noexcept(reverse_iterator(current + _Off))) /* strengthened */ {
; 1365 :         return reverse_iterator(current + _Off);
; 1366 :     }
; 1367 : 
; 1368 :     _CONSTEXPR17 reverse_iterator& operator-=(const difference_type _Off) noexcept(
; 1369 :         noexcept(current += _Off)) /* strengthened */ {
; 1370 :         current += _Off;
; 1371 :         return *this;
; 1372 :     }
; 1373 : 
; 1374 :     _NODISCARD _CONSTEXPR17 reference operator[](const difference_type _Off) const
; 1375 :         noexcept(noexcept(_Fake_copy_init<reference>(current[_Off]))) /* strengthened */ {
; 1376 :         return current[static_cast<difference_type>(-_Off - 1)];
; 1377 :     }
; 1378 : 
; 1379 : #ifdef __cpp_lib_concepts
; 1380 :     _NODISCARD_FRIEND constexpr iter_rvalue_reference_t<_BidIt> iter_move(const reverse_iterator& _It) noexcept(
; 1381 :         is_nothrow_copy_constructible_v<_BidIt>&& noexcept(_RANGES iter_move(--_STD declval<_BidIt&>()))) {
; 1382 :         auto _Tmp = _It.current;
; 1383 :         --_Tmp;
; 1384 :         return _RANGES iter_move(_Tmp);
; 1385 :     }
; 1386 : 
; 1387 :     template <indirectly_swappable<_BidIt> _BidIt2>
; 1388 :     friend constexpr void iter_swap(const reverse_iterator& _Left, const reverse_iterator<_BidIt2>& _Right) noexcept(
; 1389 :         is_nothrow_copy_constructible_v<_BidIt>&& is_nothrow_copy_constructible_v<_BidIt2>&& noexcept(
; 1390 :             _RANGES iter_swap(--_STD declval<_BidIt&>(), --_STD declval<_BidIt2&>()))) {
; 1391 :         auto _LTmp = _Left.current;
; 1392 :         auto _RTmp = _Right.base();
; 1393 :         --_LTmp;
; 1394 :         --_RTmp;
; 1395 :         _RANGES iter_swap(_LTmp, _RTmp);
; 1396 :     }
; 1397 : #endif // __cpp_lib_concepts
; 1398 : 
; 1399 :     using _Prevent_inheriting_unwrap = reverse_iterator;
; 1400 : 
; 1401 :     template <class _BidIt2, enable_if_t<_Range_verifiable_v<_BidIt, _BidIt2>, int> = 0>
; 1402 :     friend constexpr void _Verify_range(
; 1403 :         const reverse_iterator& _First, const reverse_iterator<_BidIt2>& _Last) noexcept {
; 1404 :         _Verify_range(_Last._Get_current(), _First.current); // note reversed parameters
; 1405 :     }
; 1406 : 
; 1407 :     template <class _BidIt2 = _BidIt, enable_if_t<_Offset_verifiable_v<_BidIt2>, int> = 0>
; 1408 :     constexpr void _Verify_offset(const difference_type _Off) const noexcept {
; 1409 :         _STL_VERIFY(_Off != _Min_possible_v<difference_type>, "integer overflow");
; 1410 :         current._Verify_offset(-_Off);
; 1411 :     }
; 1412 : 
; 1413 :     template <class _BidIt2 = _BidIt, enable_if_t<_Unwrappable_v<const _BidIt2&>, int> = 0>
; 1414 :     _NODISCARD constexpr reverse_iterator<_Unwrapped_t<const _BidIt2&>> _Unwrapped() const& noexcept(
; 1415 :         noexcept(static_cast<reverse_iterator<_Unwrapped_t<const _BidIt2&>>>(current._Unwrapped()))) {
; 1416 :         return static_cast<reverse_iterator<_Unwrapped_t<const _BidIt2&>>>(current._Unwrapped());
; 1417 :     }
; 1418 :     template <class _BidIt2 = _BidIt, enable_if_t<_Unwrappable_v<_BidIt2>, int> = 0>
; 1419 :     _NODISCARD constexpr reverse_iterator<_Unwrapped_t<_BidIt2>> _Unwrapped() && noexcept(
; 1420 :         noexcept(static_cast<reverse_iterator<_Unwrapped_t<_BidIt2>>>(_STD move(current)._Unwrapped()))) {
; 1421 :         return static_cast<reverse_iterator<_Unwrapped_t<_BidIt2>>>(_STD move(current)._Unwrapped());
; 1422 :     }
; 1423 : 
; 1424 :     static constexpr bool _Unwrap_when_unverified = _Do_unwrap_when_unverified_v<_BidIt>;
; 1425 : 
; 1426 :     template <class _Src, enable_if_t<_Wrapped_seekable_v<_BidIt, const _Src&>, int> = 0>
; 1427 :     constexpr void _Seek_to(const reverse_iterator<_Src>& _It) noexcept(noexcept(current._Seek_to(_It.current))) {
; 1428 :         current._Seek_to(_It.current);
; 1429 :     }
; 1430 : 
; 1431 :     _NODISCARD constexpr const _BidIt& _Get_current() const noexcept {
; 1432 :         return current;
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File D:\__Repos\__MyRepos\Raven_VS2022\Raven\goals\AttackTargetGoal_Evaluator.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File D:\__Repos\__MyRepos\Raven_VS2022\Raven\goals\ExploreGoal_Evaluator.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File D:\__Repos\__MyRepos\Raven_VS2022\Raven\goals\GetHealthGoal_Evaluator.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File D:\__Repos\__MyRepos\Raven_VS2022\Raven\goals\GetWeaponGoal_Evaluator.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File D:\__Repos\__MyRepos\Raven_VS2022\Raven\goals\Goal_AttackTarget.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File D:\__Repos\__MyRepos\Raven_VS2022\Raven\goals\Goal_GetItem.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File D:\__Repos\__MyRepos\Raven_VS2022\Raven\goals\Goal_Explore.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File D:\__Repos\__MyRepos\Raven_VS2022\Raven\goals\Goal_MoveToPosition.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File D:\__Repos\__MyRepos\Raven_VS2022\Raven\goals\Goal_Think.cpp
_TEXT	SEGMENT
tv139 = -76						; size = 4
tv146 = -72						; size = 4
tv144 = -68						; size = 4
...
; Function compile flags: /Odtp /RTCsu
; File D:\__Repos\__MyRepos\Raven_VS2022\Raven\goals\Goal_Think.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File D:\__Repos\__MyRepos\Raven_VS2022\Common\Goals\Goal_Composite.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File D:\__Repos\__MyRepos\Raven_VS2022\Raven\goals\Goal_Evaluator.h
...
; 226  :   void TextColor(int color){assert(color < NumColors); SetTextColor(m_hdc, colors[color]);}
	...
	push	226					; 000000e2H
	push	OFFSET ??_C@_1GK@CEPMINEG@?$AAD?$AA?3?$AA?2?$AA_?$AA_?$AAR?$AAe?$AAp?$AAo?$AAs?$AA?2?$AA_?$AA_?$AAM?$AAy@
