...
CONST	SEGMENT
$SG173165 DB	'Bot_MaxSwimmingSpeed', 00H
$SG173197 DB	00H
	ORG $+2
$SG173167 DB	'Bot_MaxCrawlingSpeed', 00H
	ORG $+3
$SG173195 DB	'BOT ', 00H
	ORG $+3
$SG173196 DB	' IS STUCK!!', 00H
$SG173201 DB	'Bot_MaxSpeed', 00H
	ORG $+3
?colors@@3QBKB DD 0ffH					; colors
	...
	DD	0c8c8c8H
	DD	0e6e6ffH
$SG181518 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
	DB	'VC\Tools\MSVC\14.33.31629\include\xlocale', 00H
	ORG $+2
$SG181932 DB	'invalid argument', 00H
	ORG $+3
$SG181933 DB	'%s', 00H
	ORG $+1
$SG181936 DB	00H, 00H
	ORG $+2
$SG181934 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
	DB	'VC\Tools\MSVC\14.33.31629\include\xmemory', 00H
	ORG $+6
$SG181935 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
	...
	DB	00H, 00H
$SG181937 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
...
$LN7@Allocate_m:
	push	OFFSET $SG181932
	push	OFFSET $SG181933
	push	0
	push	137					; 00000089H
	push	OFFSET $SG181934
	push	2
	call	__CrtDbgReport
...
$LN12@Allocate_m:
	push	0
	push	137					; 00000089H
	push	OFFSET $SG181935
	push	OFFSET $SG181936
	push	OFFSET $SG181937
...
; 124  :     debug_con << "BOT " << m_pOwner->ID() << " IS STUCK!!" << "";
	...
	mov	DWORD PTR $T1[ebp], eax
	push	OFFSET $SG173197
	push	OFFSET $SG173196
	lea	eax, DWORD PTR $T1[ebp]
	push	eax
	push	OFFSET $SG173195
