...
CONST	SEGMENT
$SG173350 DB	'Bot_MaxSwimmingSpeed', 00H
$SG173382 DB	00H
	ORG $+2
$SG173352 DB	'Bot_MaxCrawlingSpeed', 00H
	ORG $+3
$SG173380 DB	'BOT ', 00H
	ORG $+3
$SG173381 DB	' IS STUCK!!', 00H
$SG173386 DB	'Bot_MaxSpeed', 00H
	ORG $+3
$SG182025 DB	'invalid argument', 00H
	ORG $+3
$SG181613 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
	DB	'VC\Tools\MSVC\14.34.31933\include\xlocale', 00H
	ORG $+2
$SG182026 DB	'%s', 00H
	ORG $+1
$SG182027 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
	DB	'VC\Tools\MSVC\14.34.31933\include\xmemory', 00H
	ORG $+2
$SG182029 DB	00H, 00H
	ORG $+2
$SG182028 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
	...
	DB	00H, 00H
$SG182030 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
...
$LN7@Allocate_m:
	push	OFFSET $SG182025
	push	OFFSET $SG182026
	push	0
	push	135					; 00000087H
	push	OFFSET $SG182027
	push	2
	call	__CrtDbgReport
...
$LN12@Allocate_m:
	push	0
	push	135					; 00000087H
	push	OFFSET $SG182028
	push	OFFSET $SG182029
...
; 124  :     debug_con << "BOT " << m_pOwner->ID() << " IS STUCK!!" << "";
	...
	mov	DWORD PTR $T1[ebp], eax
	push	OFFSET $SG173382
	push	OFFSET $SG173381
	lea	eax, DWORD PTR $T1[ebp]
	push	eax
	push	OFFSET $SG173380
