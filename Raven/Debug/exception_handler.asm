...
$SG42526 DB	'''', 00H
	ORG $+2
$SG42546 DB	'std::logic_error', 00H
	ORG $+3
$SG42547 DB	'std::runtime_error', 00H
	ORG $+1
$SG42548 DB	'std::exception', 00H
	ORG $+1
$SG42550 DB	'c-string', 00H
	ORG $+3
$SG42551 DB	'Unknown C++ exception', 00H
	ORG $+2
$SG45313 DB	'invalid argument', 00H
	ORG $+3
$SG45314 DB	'%s', 00H
	ORG $+1
$SG45317 DB	00H, 00H
	ORG $+2
$SG45315 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
	DB	'VC\Tools\MSVC\14.33.31629\include\xmemory', 00H
	ORG $+6
$SG45316 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
	...
	DB	00H, 00H
$SG45318 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
...
?handler_chain@?A0x68271b3b@detail@luabind@@3PAUexception_handler_base@23@A DD 01H DUP (?) ; luabind::detail::`anonymous namespace'::handler_chain
_BSS	ENDS
CRT$XCU	SEGMENT
...
_what$ = 16						; size = 4
?push_exception_string@?A0x68271b3b@detail@luabind@@YAXPAUlua_State@@PBD1@Z PROC ; luabind::detail::`anonymous namespace'::push_exception_string
...
; 27   :   }
	...
	pop	ebp
	ret	0
?push_exception_string@?A0x68271b3b@detail@luabind@@YAXPAUlua_State@@PBD1@Z ENDP ; luabind::detail::`anonymous namespace'::push_exception_string
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File D:\__Repos\__MyRepos\Raven_VS2022\Common\luabind-0.9.1\src\exception_handler.cpp
_TEXT	SEGMENT
...
; 73   :     if (!handler_chain) handler_chain = handler;
	...
	cmp	DWORD PTR ?handler_chain@?A0x68271b3b@detail@luabind@@3PAUexception_handler_base@23@A, 0 ; luabind::detail::`anonymous namespace'::handler_chain
	jne	SHORT $LN5@register_e
	mov	eax, DWORD PTR _handler$[ebp]
	mov	DWORD PTR ?handler_chain@?A0x68271b3b@detail@luabind@@3PAUexception_handler_base@23@A, eax ; luabind::detail::`anonymous namespace'::handler_chain
...
; 76   :         exception_handler_base* p = handler_chain;
	...
	mov	ecx, DWORD PTR ?handler_chain@?A0x68271b3b@detail@luabind@@3PAUexception_handler_base@23@A ; luabind::detail::`anonymous namespace'::handler_chain
...
; 51   :         push_exception_string(L, "std::logic_error", e.what());
	...
	mov	ecx, DWORD PTR _L$[ebp]
	push	ecx
	call	?push_exception_string@?A0x68271b3b@detail@luabind@@YAXPAUlua_State@@PBD1@Z ; luabind::detail::`anonymous namespace'::push_exception_string
