; Listing generated by Microsoft (R) Optimizing Compiler Version 19.35.32215.0 
	...
	TITLE	D:\__Repos\__MyRepos\Raven_VS2022\Raven\Debug\Goal_SeekToPosition.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG180473 DB	'invalid argument', 00H
$SG172542 DB	00H
	ORG $+2
$SG180474 DB	'%s', 00H
	ORG $+1
$SG180475 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
	DB	'VC\Tools\MSVC\14.35.32215\include\xmemory', 00H
	ORG $+2
$SG180477 DB	00H, 00H
	ORG $+2
$SG180476 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
	...
	DB	00H, 00H
$SG180478 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
	DB	'i', 00H, 'd', 00H, ' ', 00H, 'a', 00H, 'r', 00H, 'g', 00H, 'u'
	DB	00H, 'm', 00H, 'e', 00H, 'n', 00H, 't', 00H, '"', 00H, 00H, 00H
	ORG $+2
$SG172540 DB	'BOT ', 00H
	ORG $+3
$SG172541 DB	' IS STUCK!!', 00H
?colors@@3QBKB DD 0ffH					; colors
	...
	DD	0e6e6ffH
	ORG $+4
$SG180068 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File D:\__Repos\__MyRepos\Raven_VS2022\Raven\goals\Goal_SeekToPosition.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
...
; 86   :     debug_con << "BOT " << m_pOwner->ID() << " IS STUCK!!" << "";
	...
	push	OFFSET $SG172542
	push	OFFSET $SG172541
	lea	eax, DWORD PTR $T1[ebp]
	push	eax
	push	OFFSET $SG172540
