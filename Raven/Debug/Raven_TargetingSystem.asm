; Listing generated by Microsoft (R) Optimizing Compiler Version 19.35.32215.0 
	...
	TITLE	D:\__Repos\__MyRepos\Raven_VS2022\Raven\Debug\Raven_TargetingSystem.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG168721 DB	'invalid argument', 00H
	ORG $+3
$SG168722 DB	'%s', 00H
	ORG $+1
$SG168723 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
	DB	'VC\Tools\MSVC\14.35.32215\include\xmemory', 00H
	ORG $+2
$SG168725 DB	00H, 00H
	ORG $+2
$SG168724 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
	...
	DB	00H, 00H
$SG168726 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
...
$LN7@Allocate_m:
	push	OFFSET $SG168721
	push	OFFSET $SG168722
	push	0
	push	135					; 00000087H
	push	OFFSET $SG168723
	push	2
	call	__CrtDbgReport
...
$LN12@Allocate_m:
	push	0
	push	135					; 00000087H
	push	OFFSET $SG168724
	push	OFFSET $SG168725
	push	OFFSET $SG168726
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File D:\__Repos\__MyRepos\Raven_VS2022\Raven\Raven_TargetingSystem.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
