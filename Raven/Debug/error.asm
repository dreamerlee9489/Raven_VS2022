...
_BSS	SEGMENT
?pcall_callback@?A0x28d620a1@luabind@@3P6AHPAUlua_State@@@ZA DD 01H DUP (?) ; luabind::`anonymous namespace'::pcall_callback
_BSS	ENDS
;	COMDAT rtc$TMZ
rtc$TMZ	SEGMENT
...
; 75   : 		return pcall_callback;
	...
	mov	eax, DWORD PTR ?pcall_callback@?A0x28d620a1@luabind@@3P6AHPAUlua_State@@@ZA ; luabind::`anonymous namespace'::pcall_callback
...
; 70   : 		pcall_callback = e;
	...
	mov	DWORD PTR ?pcall_callback@?A0x28d620a1@luabind@@3P6AHPAUlua_State@@@ZA, eax ; luabind::`anonymous namespace'::pcall_callback
