...
CONST	SEGMENT
$SG181111 DB	'invalid argument', 00H
	ORG $+3
$SG181112 DB	'%s', 00H
	ORG $+1
$SG181113 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
	DB	'VC\Tools\MSVC\14.33.31629\include\xmemory', 00H
	ORG $+2
$SG181115 DB	00H, 00H
	ORG $+2
$SG181114 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
	...
	DB	00H, 00H
$SG181116 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
...
?colors@@3QBKB DD 0ffH					; colors
	...
	DD	0c8c8c8H
	DD	0e6e6ffH
$SG181240 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
	DB	'VC\Tools\MSVC\14.33.31629\include\xlocale', 00H
	ORG $+2
$SG172020 DB	'Pellet_MaxForce', 00H
$SG172021 DB	'Pellet_Mass', 00H
$SG172022 DB	'Pellet_MaxSpeed', 00H
$SG172023 DB	'Pellet_Scale', 00H
	ORG $+3
$SG172024 DB	'Pellet_Damage', 00H
	ORG $+2
$SG172025 DB	'Pellet_Persistance', 00H
CONST	ENDS
...
$LN7@Allocate_m:
	push	OFFSET $SG181111
	push	OFFSET $SG181112
	push	0
	push	137					; 00000089H
	push	OFFSET $SG181113
	push	2
	call	__CrtDbgReport
...
$LN12@Allocate_m:
	push	0
	push	137					; 00000089H
	push	OFFSET $SG181114
	push	OFFSET $SG181115
	push	OFFSET $SG181116
...
; 21   :         Raven_Projectile(target,
	...
	push	OFFSET $SG172020
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	sub	esp, 8
	fstp	QWORD PTR [esp]
	push	OFFSET $SG172021
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	sub	esp, 8
	fstp	QWORD PTR [esp]
	push	OFFSET $SG172022
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	sub	esp, 8
	fstp	QWORD PTR [esp]
	push	OFFSET $SG172023
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	sub	esp, 8
	fstp	QWORD PTR [esp]
	push	OFFSET $SG172024
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
