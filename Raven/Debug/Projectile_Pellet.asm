...
CONST	SEGMENT
$SG172274 DB	'Pellet_MaxForce', 00H
$SG172275 DB	'Pellet_Mass', 00H
$SG172276 DB	'Pellet_MaxSpeed', 00H
$SG172277 DB	'Pellet_Scale', 00H
	ORG $+3
$SG172278 DB	'Pellet_Damage', 00H
	ORG $+2
$SG172279 DB	'Pellet_Persistance', 00H
	ORG $+1
$SG181248 DB	'invalid argument', 00H
	ORG $+3
$SG181249 DB	'%s', 00H
	ORG $+1
$SG181250 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
	DB	'VC\Tools\MSVC\14.34.31933\include\xmemory', 00H
	ORG $+2
$SG181252 DB	00H, 00H
	ORG $+2
$SG181251 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
	...
	DB	00H, 00H
$SG181253 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
...
?colors@@3QBKB DD 0ffH					; colors
	...
	DD	0c8c8c8H
	DD	0e6e6ffH
$SG181376 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
...
$LN7@Allocate_m:
	push	OFFSET $SG181248
	push	OFFSET $SG181249
	push	0
	push	135					; 00000087H
	push	OFFSET $SG181250
	push	2
	call	__CrtDbgReport
...
$LN12@Allocate_m:
	push	0
	push	135					; 00000087H
	push	OFFSET $SG181251
	push	OFFSET $SG181252
	push	OFFSET $SG181253
...
; 21   :         Raven_Projectile(target,
	...
	push	OFFSET $SG172274
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	sub	esp, 8
	fstp	QWORD PTR [esp]
	push	OFFSET $SG172275
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	sub	esp, 8
