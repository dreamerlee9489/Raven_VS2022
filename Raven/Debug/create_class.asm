...
CONST	SEGMENT
$SG100128 DB	'__init', 00H
?yield@luabind@@3U?$policy_cons@Uyield_policy@detail@luabind@@Unull_type@23@@detail@1@B	ORG $+1 ; luabind::yield
$SG100131 DB	'__finalize', 00H
	ORG $+1
$SG100146 DB	'internal error, please report', 00H
	ORG $+2
$SG100153 DB	'expected class to derive from or a newline', 00H
	ORG $+1
$SG100147 DB	'D', 00H, ':', 00H, '\', 00H, '_', 00H, '_', 00H, 'R', 00H
...
$SG100148 DB	'(', 00H, 'c', 00H, 'r', 00H, 'e', 00H, 'p', 00H, ' ', 00H
	...
	DB	'"', 00H, 00H, 00H
	ORG $+2
$SG100149 DB	'internal error, please report', 00H
	ORG $+2
$SG100150 DB	'D', 00H, ':', 00H, '\', 00H, '_', 00H, '_', 00H, 'R', 00H
	DB	'e', 00H, 'p', 00H, 'o', 00H, 's', 00H, '\', 00H, '_', 00H, '_'
	DB	00H, 'M', 00H, 'y', 00H, 'R', 00H, 'e', 00H, 'p', 00H, 'o', 00H
	DB	's', 00H, '\', 00H, 'R', 00H, 'a', 00H, 'v', 00H, 'e', 00H, 'n'
	DB	00H, '_', 00H, 'V', 00H, 'S', 00H, '2', 00H, '0', 00H, '2', 00H
	...
	DB	00H, '_', 00H, 'c', 00H, 'l', 00H, 'a', 00H, 's', 00H, 's', 00H
	DB	'.', 00H, 'c', 00H, 'p', 00H, 'p', 00H, 00H, 00H
$SG100151 DB	'(', 00H, 'i', 00H, 's', 00H, '_', 00H, 'c', 00H, 'l', 00H
...
$SG100166 DB	'invalid construct, expected class name', 00H
	ORG $+1
$SG100168 DB	'luabind does not support class names with extra nulls', 00H
	ORG $+2
$SG104582 DB	'invalid argument', 00H
	ORG $+3
$SG104583 DB	'%s', 00H
	ORG $+1
$SG104586 DB	00H, 00H
	ORG $+2
$SG104584 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
	DB	'VC\Tools\MSVC\14.35.32215\include\xmemory', 00H
	ORG $+6
$SG104585 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
	...
	DB	00H, 00H
$SG104587 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
...
_TEXT	SEGMENT
_L$ = 8							; size = 4
?copy_member_table@?A0xba65b913@detail@luabind@@YAXPAUlua_State@@@Z PROC ; luabind::detail::`anonymous namespace'::copy_member_table
...
; 62   : 		}
	...
	pop	ebp
	ret	0
?copy_member_table@?A0xba65b913@detail@luabind@@YAXPAUlua_State@@@Z ENDP ; luabind::detail::`anonymous namespace'::copy_member_table
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File D:\__Repos\__MyRepos\Raven_VS2022\Common\luabind-0.9.1\src\create_class.cpp
_TEXT	SEGMENT
...
; 93   : 		copy_member_table(L);
	...
	mov	ecx, DWORD PTR _L$[ebp]
	push	ecx
	call	?copy_member_table@?A0xba65b913@detail@luabind@@YAXPAUlua_State@@@Z ; luabind::detail::`anonymous namespace'::copy_member_table
	add	esp, 4
