...
CONST	SEGMENT
$SG101451 DB	'__init', 00H
?yield@luabind@@3U?$policy_cons@Uyield_policy@detail@luabind@@Unull_type@23@@detail@1@B	ORG $+1 ; luabind::yield
$SG101454 DB	'__finalize', 00H
	ORG $+1
$SG101469 DB	'internal error, please report', 00H
	ORG $+2
$SG101476 DB	'expected class to derive from or a newline', 00H
	ORG $+1
$SG101470 DB	'D', 00H, ':', 00H, '\', 00H, '_', 00H, '_', 00H, 'R', 00H
...
$SG101471 DB	'(', 00H, 'c', 00H, 'r', 00H, 'e', 00H, 'p', 00H, ' ', 00H
	...
	DB	'"', 00H, 00H, 00H
	ORG $+2
$SG101472 DB	'internal error, please report', 00H
	ORG $+2
$SG101473 DB	'D', 00H, ':', 00H, '\', 00H, '_', 00H, '_', 00H, 'R', 00H
	DB	'e', 00H, 'p', 00H, 'o', 00H, 's', 00H, '\', 00H, '_', 00H, '_'
	DB	00H, 'M', 00H, 'y', 00H, 'R', 00H, 'e', 00H, 'p', 00H, 'o', 00H
	DB	's', 00H, '\', 00H, 'R', 00H, 'a', 00H, 'v', 00H, 'e', 00H, 'n'
	DB	00H, '_', 00H, 'V', 00H, 'S', 00H, '2', 00H, '0', 00H, '2', 00H
	...
	DB	00H, '_', 00H, 'c', 00H, 'l', 00H, 'a', 00H, 's', 00H, 's', 00H
	DB	'.', 00H, 'c', 00H, 'p', 00H, 'p', 00H, 00H, 00H
$SG101474 DB	'(', 00H, 'i', 00H, 's', 00H, '_', 00H, 'c', 00H, 'l', 00H
...
$SG101489 DB	'invalid construct, expected class name', 00H
	ORG $+1
$SG101491 DB	'luabind does not support class names with extra nulls', 00H
	ORG $+2
$SG105956 DB	'invalid argument', 00H
	ORG $+3
$SG105957 DB	'%s', 00H
	ORG $+1
$SG105960 DB	00H, 00H
	ORG $+2
$SG105958 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
	DB	'VC\Tools\MSVC\14.33.31629\include\xmemory', 00H
	ORG $+6
$SG105959 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
	...
	DB	00H, 00H
$SG105961 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
...
_TEXT	SEGMENT
_L$ = 8							; size = 4
?copy_member_table@?A0x135df1bd@detail@luabind@@YAXPAUlua_State@@@Z PROC ; luabind::detail::`anonymous namespace'::copy_member_table
...
; 62   : 		}
	...
	pop	ebp
	ret	0
?copy_member_table@?A0x135df1bd@detail@luabind@@YAXPAUlua_State@@@Z ENDP ; luabind::detail::`anonymous namespace'::copy_member_table
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File D:\__Repos\__MyRepos\Raven_VS2022\Common\luabind-0.9.1\src\create_class.cpp
_TEXT	SEGMENT
...
; 69   : 		assert((crep != 0) && "internal error, please report");
	...
	je	SHORT $LN4@stage2
	mov	ecx, OFFSET $SG101469
	test	ecx, ecx
	jne	SHORT $LN5@stage2
$LN4@stage2:
	push	69					; 00000045H
	push	OFFSET $SG101470
	push	OFFSET $SG101471
	call	__wassert
	add	esp, 12					; 0000000cH
$LN5@stage2:
...
; 93   : 		copy_member_table(L);
	...
	mov	ecx, DWORD PTR _L$[ebp]
	push	ecx
	call	?copy_member_table@?A0x135df1bd@detail@luabind@@YAXPAUlua_State@@@Z ; luabind::detail::`anonymous namespace'::copy_member_table
	add	esp, 4
