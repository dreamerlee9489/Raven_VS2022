; Listing generated by Microsoft (R) Optimizing Compiler Version 19.35.32215.0 
	...
	TITLE	D:\__Repos\__MyRepos\Raven_VS2022\Raven\Debug\Raven_SteeringBehaviors.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG180295 DB	'invalid argument', 00H
	ORG $+3
$SG180296 DB	'%s', 00H
	ORG $+1
$SG180297 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
	DB	'VC\Tools\MSVC\14.35.32215\include\xmemory', 00H
	ORG $+2
$SG180299 DB	00H, 00H
	ORG $+2
$SG180298 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
	...
	DB	00H, 00H
$SG180300 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
...
?colors@@3QBKB DD 0ffH					; colors
	...
	DD	0c8c8c8H
	DD	0e6e6ffH
$SG171007 DB	'WallDetectionFeelerLength', 00H
	ORG $+2
$SG171008 DB	'SeparationWeight', 00H
	ORG $+3
$SG171009 DB	'WanderWeight', 00H
	ORG $+3
$SG171010 DB	'WallAvoidanceWeight', 00H
$SG171011 DB	'SeekWeight', 00H
	ORG $+1
$SG171012 DB	'ArriveWeight', 00H
	ORG $+3
$SG171013 DB	'ViewDistance', 00H
	ORG $+3
$SG179886 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
...
$LN7@Allocate_m:
	push	OFFSET $SG180295
	push	OFFSET $SG180296
	push	0
	push	135					; 00000087H
	push	OFFSET $SG180297
	push	2
	call	__CrtDbgReport
...
$LN12@Allocate_m:
	push	0
	push	135					; 00000087H
	push	OFFSET $SG180298
	push	OFFSET $SG180299
	push	OFFSET $SG180300
...
; 1884 :     _Alloc_ptr_t<_Alloc> _First, _Alloc_size_t<_Alloc> _Count, _Alloc& _Al) {
...
; 1885 :     // value-initialize _Count objects to raw _First, using _Al
; 1886 :     using _Ptrty = typename _Alloc::value_type*;
; 1887 :     if constexpr (_Use_memset_value_construct_v<_Ptrty> && _Uses_default_construct<_Alloc, _Ptrty>::value) {
; 1888 : #if _HAS_CXX20
; 1889 :         if (!_STD is_constant_evaluated())
; 1890 : #endif // _HAS_CXX20
; 1891 :         {
; 1892 :             auto _PFirst = _Unfancy(_First);
; 1893 :             _Zero_range(_PFirst, _PFirst + _Count);
; 1894 :             return _First + _Count;
; 1895 :         }
; 1896 :     }
; 1897 : 
; 1898 :     _Uninitialized_backout_al<_Alloc> _Backout{_First, _Al};
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File D:\__Repos\__MyRepos\Raven_VS2022\Common\game\EntityFunctionTemplates.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File D:\__Repos\__MyRepos\Raven_VS2022\Raven\Raven_SteeringBehaviors.cpp
_TEXT	SEGMENT
$T1 = -20						; size = 16
_this$ = -4						; size = 4
