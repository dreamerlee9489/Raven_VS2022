...
?colors@@3QBKB DD 0ffH					; colors
	...
	DD	0c8c8c8H
	DD	0e6e6ffH
$SG170630 DB	'WallDetectionFeelerLength', 00H
	ORG $+2
$SG170631 DB	'SeparationWeight', 00H
	ORG $+3
$SG170632 DB	'WanderWeight', 00H
	ORG $+3
$SG170633 DB	'WallAvoidanceWeight', 00H
$SG170634 DB	'SeekWeight', 00H
	ORG $+1
$SG170635 DB	'ArriveWeight', 00H
	ORG $+3
$SG170636 DB	'ViewDistance', 00H
	ORG $+3
$SG180008 DB	'invalid argument', 00H
	ORG $+3
$SG179599 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
	DB	'VC\Tools\MSVC\14.33.31629\include\xlocale', 00H
	ORG $+2
$SG180009 DB	'%s', 00H
	ORG $+1
$SG180010 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
	DB	'VC\Tools\MSVC\14.33.31629\include\xmemory', 00H
	ORG $+2
$SG180012 DB	00H, 00H
	ORG $+2
$SG180011 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
	...
	DB	00H, 00H
$SG180013 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
...
$LN7@Allocate_m:
	push	OFFSET $SG180008
	push	OFFSET $SG180009
	push	0
	push	137					; 00000089H
	push	OFFSET $SG180010
	push	2
	call	__CrtDbgReport
...
$LN12@Allocate_m:
	push	0
	push	137					; 00000089H
	push	OFFSET $SG180011
	push	OFFSET $SG180012
	push	OFFSET $SG180013
...
; 684  :         : _Mypair(_One_then_variadic_args_t{}, _Al) {
