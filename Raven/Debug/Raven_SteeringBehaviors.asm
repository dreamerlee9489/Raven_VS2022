...
?colors@@3QBKB DD 0ffH					; colors
	...
	DD	0c8c8c8H
	DD	0e6e6ffH
$SG170927 DB	'WallDetectionFeelerLength', 00H
	ORG $+2
$SG170928 DB	'SeparationWeight', 00H
	ORG $+3
$SG170929 DB	'WanderWeight', 00H
	ORG $+3
$SG170930 DB	'WallAvoidanceWeight', 00H
$SG170931 DB	'SeekWeight', 00H
	ORG $+1
$SG170932 DB	'ArriveWeight', 00H
	ORG $+3
$SG170933 DB	'ViewDistance', 00H
	ORG $+3
$SG180200 DB	'invalid argument', 00H
	ORG $+3
$SG179793 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
	DB	'VC\Tools\MSVC\14.34.31933\include\xlocale', 00H
	ORG $+2
$SG180201 DB	'%s', 00H
	ORG $+1
$SG180202 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
	DB	'VC\Tools\MSVC\14.34.31933\include\xmemory', 00H
	ORG $+2
$SG180204 DB	00H, 00H
	ORG $+2
$SG180203 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
	...
	DB	00H, 00H
$SG180205 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
...
$LN7@Allocate_m:
	push	OFFSET $SG180200
	push	OFFSET $SG180201
	push	0
	push	135					; 00000087H
	push	OFFSET $SG180202
	push	2
	call	__CrtDbgReport
...
$LN12@Allocate_m:
	push	0
	push	135					; 00000087H
	push	OFFSET $SG180203
	push	OFFSET $SG180204
	push	OFFSET $SG180205
