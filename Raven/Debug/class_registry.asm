...
$SG107719 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
	...
	DB	00H, 00H
$SG107721 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
	DB	'i', 00H, 'd', 00H, ' ', 00H, 'a', 00H, 'r', 00H, 'g', 00H, 'u'
	DB	00H, 'm', 00H, 'e', 00H, 'n', 00H, 't', 00H, '"', 00H, 00H, 00H
	ORG $+2
$SG101465 DB	'__luabind_classrep', 00H
	ORG $+1
$SG101466 DB	'__gc', 00H
	ORG $+3
$SG101467 DB	'__call', 00H
	ORG $+1
$SG101468 DB	'__index', 00H
$SG101469 DB	'__newindex', 00H
	ORG $+1
$SG101473 DB	'__luabind_classrep', 00H
	ORG $+1
$SG101474 DB	'__gc', 00H
	ORG $+3
$SG101475 DB	'__newindex', 00H
	ORG $+1
$SG101476 DB	'__call', 00H
	ORG $+1
$SG101477 DB	'__index', 00H
$SG101489 DB	'__luabind_classes', 00H
	ORG $+2
$SG101765 DB	'you are trying to register a class twice', 00H
	ORG $+7
$SG101766 DB	'D', 00H, ':', 00H, '\', 00H, '_', 00H, '_', 00H, 'R', 00H
	...
	DB	00H
	ORG $+4
$SG101767 DB	'(', 00H, 'm', 00H, '_', 00H, 'c', 00H, 'l', 00H, 'a', 00H
...
$LN7@Allocate_m:
	push	OFFSET $SG107716
	push	OFFSET $SG107717
	push	0
	push	137					; 00000089H
	push	OFFSET $SG107718
	push	2
	call	__CrtDbgReport
	add	esp, 24					; 00000018H
	cmp	eax, 1
...
$LN12@Allocate_m:
	push	0
	push	137					; 00000089H
	push	OFFSET $SG107719
	push	OFFSET $SG107720
	push	OFFSET $SG107721
	call	__invalid_parameter
	add	esp, 20					; 00000014H
	xor	ecx, ecx
...
_TEXT	SEGMENT
_L$ = 8							; size = 4
?create_lua_class_metatable@?A0x85159835@detail@luabind@@YAHPAUlua_State@@@Z PROC ; luabind::detail::`anonymous namespace'::create_lua_class_metatable
...
; 105  :         }
	...
	pop	ebp
	ret	0
?create_lua_class_metatable@?A0x85159835@detail@luabind@@YAHPAUlua_State@@@Z ENDP ; luabind::detail::`anonymous namespace'::create_lua_class_metatable
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
...
_TEXT	SEGMENT
_L$ = 8							; size = 4
?create_cpp_class_metatable@?A0x85159835@detail@luabind@@YAHPAUlua_State@@@Z PROC ; luabind::detail::`anonymous namespace'::create_cpp_class_metatable
...
; 72   :         }
	...
	pop	ebp
	ret	0
?create_cpp_class_metatable@?A0x85159835@detail@luabind@@YAHPAUlua_State@@@Z ENDP ; luabind::detail::`anonymous namespace'::create_cpp_class_metatable
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
...
; 151  :         assert((m_classes.find(info) == m_classes.end()) 
	...
	mov	edx, OFFSET $SG101765
	test	edx, edx
	jne	SHORT $LN4@add_class
$LN3@add_class:
	push	152					; 00000098H
	push	OFFSET $SG101766
	push	OFFSET $SG101767
	call	__wassert
	add	esp, 12					; 0000000cH
$LN4@add_class:
...
; 112  :         : m_cpp_class_metatable(create_cpp_class_metatable(L))
	...
	mov	eax, DWORD PTR _L$[ebp]
	push	eax
	call	?create_cpp_class_metatable@?A0x85159835@detail@luabind@@YAHPAUlua_State@@@Z ; luabind::detail::`anonymous namespace'::create_cpp_class_metatable
	add	esp, 4
	mov	ecx, DWORD PTR _this$[ebp]
...
; 113  :         , m_lua_class_metatable(create_lua_class_metatable(L))
	...
	mov	edx, DWORD PTR _L$[ebp]
	push	edx
	call	?create_lua_class_metatable@?A0x85159835@detail@luabind@@YAHPAUlua_State@@@Z ; luabind::detail::`anonymous namespace'::create_lua_class_metatable
	add	esp, 4
	mov	ecx, DWORD PTR _this$[ebp]
