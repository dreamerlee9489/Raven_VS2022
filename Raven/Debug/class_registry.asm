...
CONST	SEGMENT
$SG100136 DB	'__luabind_classrep', 00H
?piecewise_construct@std@@3Upiecewise_construct_t@1@B	ORG $+1 ; std::piecewise_construct
$SG100137 DB	'__gc', 00H
?yield@luabind@@3U?$policy_cons@Uyield_policy@detail@luabind@@Unull_type@23@@detail@1@B	ORG $+1 ; luabind::yield
	ORG $+2
$SG100138 DB	'__call', 00H
	ORG $+1
$SG100139 DB	'__index', 00H
$SG100140 DB	'__newindex', 00H
	ORG $+1
$SG100144 DB	'__luabind_classrep', 00H
	ORG $+1
$SG100145 DB	'__gc', 00H
	ORG $+3
$SG100146 DB	'__newindex', 00H
	ORG $+1
$SG100147 DB	'__call', 00H
	ORG $+1
$SG100148 DB	'__index', 00H
$SG100160 DB	'__luabind_classes', 00H
	ORG $+2
$SG100422 DB	'you are trying to register a class twice', 00H
	ORG $+3
$SG100423 DB	'D', 00H, ':', 00H, '\', 00H, '_', 00H, '_', 00H, 'R', 00H
	...
	DB	00H
$SG106298 DB	'invalid argument', 00H
	ORG $+3
$SG100424 DB	'(', 00H, 'm', 00H, '_', 00H, 'c', 00H, 'l', 00H, 'a', 00H
...
$SG106302 DB	00H, 00H
	ORG $+2
$SG106300 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
	DB	'VC\Tools\MSVC\14.34.31933\include\xmemory', 00H
	ORG $+6
$SG106301 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
	...
	DB	00H, 00H
$SG106303 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
...
$LN7@Allocate_m:
	push	OFFSET $SG106298
	push	OFFSET $SG106299
	push	0
	push	135					; 00000087H
	push	OFFSET $SG106300
	push	2
	call	__CrtDbgReport
	add	esp, 24					; 00000018H
	cmp	eax, 1
...
$LN12@Allocate_m:
	push	0
	push	135					; 00000087H
	push	OFFSET $SG106301
	push	OFFSET $SG106302
	push	OFFSET $SG106303
	call	__invalid_parameter
	add	esp, 20					; 00000014H
	xor	ecx, ecx
...
_TEXT	SEGMENT
_L$ = 8							; size = 4
?create_lua_class_metatable@?A0x6d92c6b3@detail@luabind@@YAHPAUlua_State@@@Z PROC ; luabind::detail::`anonymous namespace'::create_lua_class_metatable
...
; 105  :         }
	...
	pop	ebp
	ret	0
?create_lua_class_metatable@?A0x6d92c6b3@detail@luabind@@YAHPAUlua_State@@@Z ENDP ; luabind::detail::`anonymous namespace'::create_lua_class_metatable
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
...
_TEXT	SEGMENT
_L$ = 8							; size = 4
?create_cpp_class_metatable@?A0x6d92c6b3@detail@luabind@@YAHPAUlua_State@@@Z PROC ; luabind::detail::`anonymous namespace'::create_cpp_class_metatable
...
; 72   :         }
	...
	pop	ebp
	ret	0
?create_cpp_class_metatable@?A0x6d92c6b3@detail@luabind@@YAHPAUlua_State@@@Z ENDP ; luabind::detail::`anonymous namespace'::create_cpp_class_metatable
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
...
; 151  :         assert((m_classes.find(info) == m_classes.end()) 
	...
	mov	edx, OFFSET $SG100422
	test	edx, edx
	jne	SHORT $LN4@add_class
$LN3@add_class:
	push	152					; 00000098H
	push	OFFSET $SG100423
	push	OFFSET $SG100424
	call	__wassert
	add	esp, 12					; 0000000cH
$LN4@add_class:
...
; 112  :         : m_cpp_class_metatable(create_cpp_class_metatable(L))
	...
	mov	eax, DWORD PTR _L$[ebp]
	push	eax
	call	?create_cpp_class_metatable@?A0x6d92c6b3@detail@luabind@@YAHPAUlua_State@@@Z ; luabind::detail::`anonymous namespace'::create_cpp_class_metatable
	add	esp, 4
	mov	ecx, DWORD PTR _this$[ebp]
...
; 113  :         , m_lua_class_metatable(create_lua_class_metatable(L))
	...
	mov	edx, DWORD PTR _L$[ebp]
	push	edx
	call	?create_lua_class_metatable@?A0x6d92c6b3@detail@luabind@@YAHPAUlua_State@@@Z ; luabind::detail::`anonymous namespace'::create_lua_class_metatable
	add	esp, 4
	mov	ecx, DWORD PTR _this$[ebp]
