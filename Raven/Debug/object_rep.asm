...
CONST	SEGMENT
$SG52066 DB	'invalid argument', 00H
	ORG $+3
$SG52067 DB	'%s', 00H
	ORG $+1
$SG52068 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
	DB	'VC\Tools\MSVC\14.33.31629\include\xmemory', 00H
	ORG $+2
$SG52070 DB	00H, 00H
	ORG $+2
$SG52069 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
	...
	DB	00H, 00H
$SG52071 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
	DB	'i', 00H, 'd', 00H, ' ', 00H, 'a', 00H, 'r', 00H, 'g', 00H, 'u'
	DB	00H, 'm', 00H, 'e', 00H, 'n', 00H, 't', 00H, '"', 00H, 00H, 00H
	ORG $+2
$SG48402 DB	'__finalize', 00H
	ORG $+1
$SG48385 DB	'D', 00H, ':', 00H, '\', 00H, '_', 00H, '_', 00H, 'R', 00H
...
$SG48416 DB	'property ''%s'' is read only', 00H
	ORG $+1
$SG48386 DB	'm', 00H, '_', 00H, 'd', 00H, 'e', 00H, 'p', 00H, 'e', 00H
...
$SG48435 DB	'No such operator defined', 00H
	ORG $+3
$SG48443 DB	'__luabind_class', 00H
$SG48444 DB	'__gc', 00H
	ORG $+3
$SG48445 DB	'__index', 00H
$SG48446 DB	'__newindex', 00H
CONST	ENDS
...
_i$2 = -4						; size = 4
_L$ = 8							; size = 4
?dispatch_operator@?A0x65a47d2b@detail@luabind@@YAHPAUlua_State@@@Z PROC ; luabind::detail::`anonymous namespace'::dispatch_operator
...
; 205  :       }
	...
	pop	ebp
	ret	0
?dispatch_operator@?A0x65a47d2b@detail@luabind@@YAHPAUlua_State@@@Z ENDP ; luabind::detail::`anonymous namespace'::dispatch_operator
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File D:\__Repos\__MyRepos\Raven_VS2022\Common\luabind-0.9.1\src\object_rep.cpp
_TEXT	SEGMENT
_L$ = 8							; size = 4
?get_instance_value@?A0x65a47d2b@detail@luabind@@YAHPAUlua_State@@@Z PROC ; luabind::detail::`anonymous namespace'::get_instance_value
...
; 169  :       }
	...
	pop	ebp
	ret	0
?get_instance_value@?A0x65a47d2b@detail@luabind@@YAHPAUlua_State@@@Z ENDP ; luabind::detail::`anonymous namespace'::get_instance_value
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File D:\__Repos\__MyRepos\Raven_VS2022\Common\luabind-0.9.1\src\object_rep.cpp
_TEXT	SEGMENT
_L$ = 8							; size = 4
?set_instance_value@?A0x65a47d2b@detail@luabind@@YAHPAUlua_State@@@Z PROC ; luabind::detail::`anonymous namespace'::set_instance_value
...
; 146  :       }
	...
	pop	ebp
	ret	0
?set_instance_value@?A0x65a47d2b@detail@luabind@@YAHPAUlua_State@@@Z ENDP ; luabind::detail::`anonymous namespace'::set_instance_value
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File D:\__Repos\__MyRepos\Raven_VS2022\Common\luabind-0.9.1\src\object_rep.cpp
_TEXT	SEGMENT
...
; 221  :         lua_pushcclosure(L, get_instance_value, 0);
	...
	push	0
	push	OFFSET ?get_instance_value@?A0x65a47d2b@detail@luabind@@YAHPAUlua_State@@@Z ; luabind::detail::`anonymous namespace'::get_instance_value
	mov	ecx, DWORD PTR _L$[ebp]
	push	ecx
...
; 230  :         lua_pushcclosure(L, set_instance_value, 0);
	...
	push	0
	push	OFFSET ?set_instance_value@?A0x65a47d2b@detail@luabind@@YAHPAUlua_State@@@Z ; luabind::detail::`anonymous namespace'::set_instance_value
	mov	ecx, DWORD PTR _L$[ebp]
	push	ecx
	call	_lua_pushcclosure
	add	esp, 12					; 0000000cH
...
; 238  :             lua_pushcclosure(L, &dispatch_operator, 2);
	...
	push	2
	push	OFFSET ?dispatch_operator@?A0x65a47d2b@detail@luabind@@YAHPAUlua_State@@@Z ; luabind::detail::`anonymous namespace'::dispatch_operator
	mov	eax, DWORD PTR _L$[ebp]
	push	eax
	call	_lua_pushcclosure
	add	esp, 12					; 0000000cH
...
; 252  :         if (lua_tocfunction(L, -1) != &get_instance_value)
	...
	call	_lua_tocfunction
	add	esp, 8
	cmp	eax, OFFSET ?get_instance_value@?A0x65a47d2b@detail@luabind@@YAHPAUlua_State@@@Z ; luabind::detail::`anonymous namespace'::get_instance_value
